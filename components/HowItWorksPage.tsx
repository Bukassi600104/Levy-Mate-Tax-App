...
const HowItWorksPage: React.FC<HowItWorksPageProps> = ({ onBack, onGetStarted }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>How It Works - Calculate Nigerian Taxes in 4 Steps | LevyMate</title>
        <meta name="description" content="Learn how to calculate Nigerian taxes with LevyMate in 4 easy steps: Create profile, input income, get AI analysis, download reports. Free PAYE, CIT, VAT calculator." />
        <meta name="keywords" content="how to calculate Nigerian tax, tax calculation steps, PAYE calculation guide, CIT calculator tutorial, VAT filing Nigeria" />
        <link rel="canonical" href="https://www.levymatesystems.com/how-it-works" />
        <meta property="og:title" content="How LevyMate Works - Nigerian Tax Calculator Guide" />
        <meta property="og:description" content="Calculate Nigerian taxes in 4 easy steps. Free PAYE, CIT, VAT calculator with AI assistance." />
        <meta property="og:url" content="https://www.levymatesystems.com/how-it-works" />
      </Helmet>
      {/* Header */}
