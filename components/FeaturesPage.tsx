...
const FeaturesPage: React.FC<FeaturesPageProps> = ({ onBack, onGetStarted }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>Features - Nigerian Tax Calculator App | LevyMate Tax Software</title>
        <meta name="description" content="Explore LevyMate's powerful features: AI Tax Assistant, instant PAYE calculations, visual tax analytics, OCR receipt scanning, VAT tracking for Nigerian taxpayers and businesses." />
        <meta name="keywords" content="tax software Nigeria, tax calculator features, AI tax assistant, receipt scanning OCR, VAT tracking Nigeria, tax analytics, PAYE software" />
        <link rel="canonical" href="https://www.levymatesystems.com/features" />
        <meta property="og:title" content="LevyMate Features - Nigerian Tax Software" />
        <meta property="og:description" content="AI-powered tax calculations, OCR receipt scanning, visual analytics for Nigerian taxes." />
        <meta property="og:url" content="https://www.levymatesystems.com/features" />
      </Helmet>
      {/* Header */}
