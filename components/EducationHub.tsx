...
import { DISCLAIMER_TEXT, AI_QUERY_LIMIT_FREE, LEARNING_ARTICLES, ADMIN_EMAILS } from '../constants';
import { Send, Bot, User, ShieldAlert, ChevronRight, Lock, ArrowLeft, BookOpen, ChevronLeft, HelpCircle } from 'lucide-react';
...
const EducationHub: React.FC<EducationHubProps> = ({ profile, onUsageUpdate, onNavigateToFAQ }) => {
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-left-4">
                    ...
                    {onNavigateToFAQ && (
                        <button 
                            ...
                            className="w-full bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-xl border border-indigo-100 hover:border-indigo-200 transition-all group"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 text-left">
                                    <h4 className="font-semibold text-gray-900 text-sm">Browse FAQ</h4>
                                    <p className="text-xs text-gray-500">15 common questions answered</p>
                                </div>
